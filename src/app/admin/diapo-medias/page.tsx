  ...
  return (
    <main className="admin-main">
      ...
      <section className="metrics-grid three">
        ...
        <MetricCard label="Photos" value={items.filter((item) => item.content_type === "photo").length} hint="Images uploadées ou URL" />
        <MetricCard label="Vidéos" value={items.filter((item) => item.content_type === "video").length} hint="Liens vidéo intégrés" />
      </section>
