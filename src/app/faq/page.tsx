    ...
    <InfoPage
      ...
      sections={[
        ...
        },
        {
          ...
          text: "L’inscription se fait en ligne avec paiement sécurisé. Les 50 premiers profils retenus renverront une composition, puis 10 finalistes seront annoncés le 30 septembre.",
        },
        {
